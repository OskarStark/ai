...
- **Gemini Search** - Performs web searches using Google
...
The Gemini Search tool enables the model to search the web and incorporate search results into its responses::
